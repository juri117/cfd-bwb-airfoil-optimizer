...
def runOpenMdao():
    ...
    prob.model.add_objective('cycle.cyc1.heightLoss', scaler=1)

    prob.model.add_constraint('cycle.cyc1.height', lower=cabinHeigth * 0.95, upper=cabinHeigth * 1.05)
